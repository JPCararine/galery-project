...
export const inputTextVariants = tv({
    base: `bg-transparent outline-none placeholder:text-placeholder
...
interface InputTextProps extends Omit<React.ComponentProps<"input">, "size" | "disabled">, VariantProps<typeof inputTextWrapperVariants> {
    icon?: React.ComponentProps<typeof Icon>["svg"],
    error?: React.ReactNode;
}

export default function InputText({ size, disabled, icon,className, error, ...props }: InputTextProps) {
    return (
